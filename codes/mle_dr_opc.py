...
def mle_dr_opc(estimator='LATE'):
    ...
    torch.save(mlealphas, 'mle_opc_'+estimator+'.pt')
    torch.save(drualphas, 'dru_opc_'+estimator+'.pt')
    torch.save(drwalphas, 'drw_opc_'+estimator+'.pt')
###
